...
#define ST7735S_DC GPIO_NUM_5   // CONFIG_LV_DISP_PIN_DC
#define ST7735S_RST GPIO_NUM_12 // CONFIG_LV_DISP_PIN_RST
#define ST7735S_USE_RST 1       // CONFIG_LV_DISP_USE_RST
